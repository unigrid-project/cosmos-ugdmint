...
import (
	...
	"github.com/unigrid-project/cosmos-sdk-ugdmint/app"
)

// NewRootCmd creates a new root command for cosmos-sdk-ugdmintd. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:           app.Name + "d",
		Short:         "Start cosmossdkugdmint node",
		SilenceErrors: true,
